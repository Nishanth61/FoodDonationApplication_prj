...
class PickupFoodPacketCommandTest {
	...
	void testExecute() {
		...
		PickupFoodPacketCommand pickupFoodPacketCommand = new PickupFoodPacketCommand(expectedFoodPacket);
		String actualState = pickupFoodPacketCommand.execute();
		Assert.assertEquals("PickUp Food Packet Command", actualState);
	}
